...
$TTPDS_masterkey 		= "somerandombutcomplexmasterkey"; // Insert master key here to call admin interface using ?admin=getallaccesscodes&mkey=somerandombutcomplexmasterkey
$TTPDS_keys_maxlen 	= 50; // Truncates the $_GET["acc"] variable to prevent random attacs
